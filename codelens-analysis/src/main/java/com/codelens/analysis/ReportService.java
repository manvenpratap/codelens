...
public class ReportService {
    ...
    public String generateInteractiveHtmlSnapshot(String projectName, Object fullGraphData, Object archGraphData, ArchitectureReportData archData) {
        ...
        sb.append("  const PKG_PALETTE = ['#38bdf8', '#34d399', '#f472b6', '#a78bfa', '#fb923c', '#facc15', '#4ade80', '#2dd4bf', '#818cf8', '#e879f9', '#ef4444', '#10b981', '#6366f1', '#ec4899', '#06b6d4'];\n");
        sb.append("  function getEntityColor(str) {\n");
        sb.append("    if (!str) return '#94a3b8';\n");
        sb.append("    let hash = 0;\n");
        sb.append("    for (let i = 0; i < str.length; i++) hash = (hash << 5) - hash + str.charCodeAt(i);\n");
        ...
        sb.append("  }\n");
        sb.append("  function getClassColor(fqn, type) {\n");
        sb.append("    return getEntityColor(extractClassFqn(fqn, type));\n");
        sb.append("  }\n");
        ...
        sb.append("        pkg,\n");
        sb.append("        color: getClassColor(rn.id, nodeType),\n");
        sb.append("        arch,\n");
