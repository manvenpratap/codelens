...
const THEMES = {
  dark: {
    ...
    graph: {
      ...
      nodeColors: ['#10b981','#34d399','#f59e0b','#a855f7','#ef4444','#14b8a6','#2dd4bf','#f97316','#84cc16','#94a3b8'],
      lightMode: false,
    },
  ...
  light: {
    ...
    graph: {
      ...
      nodeColors: ['#059669','#10b981','#7c3aed','#0d9488','#e11d48','#15803d','#9333ea','#1e293b','#475569','#059669'],
      lightMode: true,
    },
