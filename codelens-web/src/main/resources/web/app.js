...
const THEMES = {
  dark: {
    ...
    css: {
      ...
      '--primary': '#60a5fa', '--primary-bg': '#2563eb', '--primary-hover': '#3b82f6', '--primary-active': '#2563eb',
  ...
  light: {
    ...
    css: {
      ...
      '--primary': '#2563eb', '--primary-bg': '#2563eb', '--primary-hover': '#1d4ed8', '--primary-active': '#1e40af',
      '--primary-subtle': 'rgba(37,99,235,0.12)', '--primary-glow': 'rgba(37,99,235,0.25)',
